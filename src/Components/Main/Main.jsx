...
const Data = [
{
...

  {
   ...
   description: 'Huayna Picchu is a mountain in Peru, rising over Machu Picchu,the so-called Lost City of Incas. This place is popular among tourists as the sunrise from the Sun Gate is simply spectacular.'
    ...
    grade: 'CULTURAL RELAX',
    fees: '$700',
    description: 'One of the most remarkable Australian gifts is the Great Barrier Reef. The hallmark of this place is lavish and beauty. Always interesting to be in this place.'
      },
...

{
    ...
    grade: 'CULTURAL RELAX',
    fees: '$500',
    description: 'Bali is an Indonesian Island and one of the best holiday destinations in the Indonesian archipelago. Bali is j=known for its volcanic mountains, history, art & culture, food, temples and beautiful sandy beaches.'
},
                ...
                return(
                    <div key={id}  data-aos="fade-up"
                     className="singleDestination">
                       ...
                       {/* Here it wil return single id from the map array*/}
